...
const SideNav = () => {
  ...
  return (
    <aside className="hidden lg:block h-screen bg-background border-r shadow-xl w-64 space-y-6 py-4 px-5 inset-y-0 left-0 transform transition-transform duration-200 ease-in-out">
